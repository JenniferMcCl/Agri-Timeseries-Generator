...
class DatacubeSatData:

    @staticmethod
    def get_Sat_imagery(polygon, layer, date, user, pw, host, epsg = 32632, band1='NIR10', band2='R', band3='G', band_subset=True, printout=False, get_query=False):
        """
        ...
        try:
            ...
            if not response:
                print("Radaman requests return is None. Aborting.")
                return response
